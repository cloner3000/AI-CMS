<?php
/**
 * App\src\Template\Webadmin\ContentsCategories\index.ctp
        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Slug", 
                        "name": "ContentsCategories.slug", 
                        "targets": 2,
                        "data" : 'slug'
                    },
                    { 
                        "title": "Status", 
                        "name": "ContentsCategories.status",
                        "className": "text-center",
                        "searchable": !1,  
                        "targets": 3,
                        "data" : 'status',
                    ...
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "ContentsCategories.created",
                        "searchable": !1,  
                        "targets": 4,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "ContentsCategories.modified", 
                        "searchable": !1,  
                        "targets": 5,
                        "data" : 'modified',
                        width:'15%',
