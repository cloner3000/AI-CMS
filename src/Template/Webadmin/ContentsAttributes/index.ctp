<?php
/**
 * App\src\Template\Webadmin\ContentsAttributes\index.ctp
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        ...
                        "name": "ContentsCategories.title", 
                        "targets": 1,
                        "data" : 'contents_category.title'
                    },
                    { 
                        "title": "Label", 
                        "name": "ContentsAttributes.label", 
                        "targets": 2,
                        "data" : 'label'
                    },
                    { 
                        "title": "Type", 
                        "name": "ContentsAttributes.type", 
                        "targets": 3,
                        "data" : 'type'
                    },
                    { 
                        "title": "Validations", 
                        "name": "ContentsAttributes.validations",
                        "className": "text-center",
                        "targets": 4,
                        "data" : 'validations',
                    },
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "ContentsAttributes.created",
                        "searchable": !1,  
                        "targets": 5,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "ContentsAttributes.modified", 
                        "searchable": !1,  
                        "targets": 6,
                        "data" : 'modified',
                        width:'15%',
