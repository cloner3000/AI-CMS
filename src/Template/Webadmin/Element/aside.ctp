<?php
/**
 * App\src\Template\Webadmin\Element\aside.ctp
            ...
            <ul class="kt-menu__nav ">
                ...
                ?>
                    <li class="kt-menu__section ">
                        <h4 class="kt-menu__section-text">WEB CONTENT</h4>
                ...
                <?php endif;?>
                <?php 
                    $countCheckSideBar = $this->Utilities->sideBarArrayCheck($sidebarList,['AppSettings','WebSettings']);
                    if($countCheckSideBar > 0):
                ?>
                    <li class="kt-menu__section ">
