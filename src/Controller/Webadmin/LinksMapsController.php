<?php
/**
 * App\src\Controller\Webadmin\LinksMapsController.php
...
class LinksMapsController extends AppController
{
    ...
    private $titleModule = "Sitemap";
    private $primaryModel = "LinksMaps";
    ...
    public function add()
    {
        ...
        $parents = $this->{$this->primaryModel}->find('treeList')->where([
            'status' => 1
        ]);
        $this->set(compact('record','parents'));
