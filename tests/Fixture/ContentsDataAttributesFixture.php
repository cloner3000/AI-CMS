...
/**
 * ContentsDataAttributesFixture
 *
 */
class ContentsDataAttributesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contents_attribute_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'content_id' => 1,
                'contents_attribute_id' => 1,
                'data' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'created' => '2019-06-10 08:28:43',
                'created_by' => 1,
                'modified' => '2019-06-10 08:28:43',
                'modified_by' => 1
            ],
        ];
        parent::init();
